...
class BusinessRepository(BaseDAO):
    ...
    def update_business(self, business_id: str, update_data: Dict) -> bool:
        ...
        # IMPORTANT: if these fields are passed in, convert to ObjectId for Mongo
        ...
        # use BaseDAO update (which uses $set internally in our wrapper style)
        # if _update_document overwrites vs $set depends on BaseDAO; safest is explicit $set:
    ...
    # -------------------------------------------------------------------------
    # business <-> suppliers relationship
    # -------------------------------------------------------------------------
    ...
    # -------------------------------------------------------------------------
    # orders linkage (needed by OrderService/OrderRepository)
    # -------------------------------------------------------------------------
